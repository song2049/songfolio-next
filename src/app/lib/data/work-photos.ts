...
export const workPhotos: WorkPhoto[] = [
  // NHN
 {
  ...
  // Miracle City (예시)
  {
    ...
    category: "event",
    src: "/images/work/jellyfish/event-01.jpg",
    ...
    companyKey: "jellyfish",
    category: "event",
    src: "/images/work/jellyfish/event-02.jpg",
    ...
    companyKey: "jellyfish",
    category: "event",
    src: "/images/work/jellyfish/event-03.jpg",
  ...
  },
  {
    ...
    companyKey: "jellyfish",
    category: "event",
    src: "/images/work/jellyfish/event-04.jpg",
  ...
  },
  {
    ...
    companyKey: "jellyfish",
    category: "event",
    src: "/images/work/jellyfish/event-05.jpg",
  ...
  },
  {
    ...
    companyKey: "jellyfish",
    category: "event",
    src: "/images/work/jellyfish/event-06.jpg",
  ...
  },
  {
    ...
    companyKey: "jellyfish",
    category: "facility",
    src: "/images/work/jellyfish/facility-01.jpg",
  ...
  },
  {
    ...
    companyKey: "jellyfish",
    category: "facility",
    src: "/images/work/jellyfish/facility-02.jpg",
    caption: "시설관리: 외부 유리창 크랙(파손)으로 교체 작업 진행",
  },
  {
    id: "jellyfish-9",
    companyKey: "jellyfish",
    category: "facility",
    src: "/images/work/jellyfish/facility-03.jpg",
    caption: "시설관리: 외부 유리창 크랙(파손)으로 교체 작업 진행",
  },

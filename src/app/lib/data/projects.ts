...
export const projects: Project[] = [
 ...
 {
  slug: "operations-support-project",
  title: "기업 운영지원 및 행사·시설 총무 프로젝트",
  summary:
    "외주 프로젝트 형태로 행사 운영·VIP 의전·브랜드 제작·구매·시설 지원 등 기업 운영 전반을 수행한 총무 운영 경험",
  period: "2024.09 ~ 2025.03",
  role: "총무 운영지원 · 행사·시설·구매 실무 수행",
  stack: ["행사 운영", "VIP 의전", "구매/계약", "시설관리", "브랜드 제작"],

  highlights: [
    "외부 행사 기획 및 운영 지원, VIP 의전 수행",
    "사내 홈페이지·명함·브랜드 제작물 내재화로 비용 절감",
    "구매 요청 대응 및 협력사 커뮤니케이션 체계 운영",
    "시설 유지보수 및 사업장 운영 지원 업무 수행",
  ],

  cover: "/projects/operations-support/cover.png",
  featured: true,
  ...
  stats: [
    { label: "Events", value: "행사 운영" },
    { label: "Facilities", value: "시설 지원" },
    { label: "Operations", value: "구매·운영 대응" },
  ],

  story: {
    problem: [
      "외부 행사 및 VIP 대응 시 운영 프로세스와 현장 대응이 요구됨",
      "브랜드 제작물·홈페이지 운영이 외주 중심으로 비용이 발생",
      "구매·시설·행사 요청이 동시에 발생하며 총무 운영 역량이 필요",
    ],

    decisions: [
      "행사 운영과 의전 업무를 실무 중심으로 지원하며 프로세스화",
      "홈페이지·명함·영상 콘텐츠를 내재화하여 즉각 대응 가능하도록 개선",
      "구매·시설 요청을 협력사와 조율하며 운영지원 체계를 정리",
    ],

    results: [
      "행사 운영 및 VIP 의전 경험을 통해 대외 커뮤니케이션 역량 강화",
      "브랜드 제작물 내재화로 외주 비용 절감 및 업무 대응 속도 개선",
      "총무 운영지원 업무 범위를 확장하며 실무 기반을 확보",
    ],

    learnings: [
      "총무 업무는 현장 대응과 운영 조율 능력이 핵심이다",
      "행사·시설·구매는 분리된 업무가 아니라 하나의 운영 흐름이다",
